...
import 'package:tugas_getapi/core/models/user.dart';
import 'package:tugas_getapi/core/resources/environtment.dart';
...
class UserHttp{
  ...
  Future<bool> addUser(String name, {DateTime? date, String avatar = " avatar",
String id = "1" }) async {
  try {
    Map<String, dynamic> userMap = User(name: name, createdAt: DateTime.now(),
avatar: avatar, id: id).toJson();
